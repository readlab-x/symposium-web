...
- 在 [阅读台](./src/routes/reading/+page.svelte) 中按发言顺序阅读文本，并结合场景筛选、人物筛选和注解辅助理解。
- 在 [人物索引](./src/routes/characters/+page.svelte) 中查看主要角色、头像、人物简介与外部百科入口。
- 在 [主题地图](./src/routes/themes/+page.svelte) 中按“荣誉、欲望、完整、美、不朽”等主题横向进入文本。
- 在 [关系图](./src/routes/relations/+page.svelte) 中查看人物之间的回应、继承、修正与叙事关联。
- 在 [全文搜索](./src/routes/search/+page.svelte) 中按关键词检索《会饮》相关文本内容。
...
项目文档入口在 [docs/README.md](./docs/README.md)。

当前建议优先阅读：

- [项目 SEO 技术文档](./docs/seo-technical-guide.md)
- [GitHub Pages 部署设计](./docs/plans/2026-03-21-github-pages-deployment-design.md)
- [GitHub Pages 部署实施计划](./docs/plans/2026-03-21-github-pages-deployment-implementation.md)
